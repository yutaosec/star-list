...
- [DouyinFE/semi-design](https://github.com/DouyinFE/semi-design)
  ...
  - 💡: `code2design` `dark-mode` `design-system` `design2code` `designops` `dsm` `react` `theme` `ui-libary`
...
- [microsoft/terminal](https://github.com/microsoft/terminal)
  ...
  - 💡: `cmd` `command-line` `console` `contributions-welcome` `good-first-issue` `terminal` `windows` `windows-console` `windows-terminal` `wsl`
