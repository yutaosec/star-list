...
- [fslongjin/This-repo-has-1307-stars](https://github.com/fslongjin/This-repo-has-1307-stars)
  - ⭐: 1,307
  - 📖: 这个仓库有1307个star，不信你试试
...
- [NvChad/NvChad](https://github.com/NvChad/NvChad)
  ...
  - 💡: `chad` `charity` `dotfiles` `foss` `ide` `lua` `neovim` `neovim-config` `neovim-configuration` `neovim-dotfiles` `neovim-lua` `neovim-setup` `nvim` `nvim-configs` `rice` `ricing` `telescope` `vim` `vimrc` `vscode`
...
- [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)
  ...
  - 💡: `python` `sponskrub` `sponsorblock` `video-downloader` `youtube-dl` `youtube-dlc` `yt-dlp`
...
- [octokit/octokit.js](https://github.com/octokit/octokit.js)
  ...
  - 💡: `github` `javascript` `octokit-js` `rest` `sdk`
...
- [DouyinFE/semi-design](https://github.com/DouyinFE/semi-design)
  ...
  - 💡: `custom-design-system` `design-system` `flexable-design-system` `react` `typescript` `ui-libary`
...
- [vant-ui/vant](https://github.com/vant-ui/vant)
  - ⭐: 20,158
...
- [imba/imba](https://github.com/imba/imba)
  ...
  - 💡: `dom` `frontend` `imba` `javascript` `programming-language`
