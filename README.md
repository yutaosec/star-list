...
- [NvChad/NvChad](https://github.com/NvChad/NvChad)
  ...
  - 💡: `dotfiles` `editor` `foss` `ide` `lua` `neovim` `neovim-config` `neovim-configuration` `neovim-dotfiles` `neovim-lua` `neovim-setup` `nvim` `nvim-configs` `open-source` `rice` `ricing` `vim` `vim-distribution` `vimrc` `vscode`
