...
- [adityatelange/hugo-PaperMod](https://github.com/adityatelange/hugo-PaperMod)
  ...
  - 💡: `blog` `blog-theme` `clean` `fast` `feature-rich` `grayscale` `high-performance` `hugo` `hugo-blog-theme` `hugo-theme` `mit-license` `papermod` `portfolio` `theme` `well-documented`
...
- [samber/lo](https://github.com/samber/lo)
  ...
  - 💡: `constraints` `contract` `filterable` `foldable` `functional` `generics` `go` `golang` `hacktoberfest` `lodash` `programming` `typesafe`

- [ant-design/antd-tools](https://github.com/ant-design/antd-tools)
  - ⭐: 351
...
- [kifuan/helang](https://github.com/kifuan/helang)
  - ⭐: 2,218
  - 📖: 何语言，次世代赛博编程语言。
...
- [microsoft/rushstack](https://github.com/microsoft/rushstack)
  ...
  - 💡: `api` `api-extractor` `build` `eslint` `hacktoberfest` `monorepo` `nodejs` `orchestrator` `rush` `toolchain` `typescript`
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder)
  ...
  - 💡: `android` `api` `app` `bark` `call` `dingding` `forward` `pushdear` `pushplus` `serverchan` `sms` `smtp` `telegram` `webhook` `wechatapp`
...
- [statelyai/xstate](https://github.com/statelyai/xstate)
  ...
  - 💡: `finite-state-machine` `fsm` `hacktoberfest` `interpreter` `javascript` `orchestration` `scxml` `state` `state-machine` `state-management` `statechart` `statecharts` `typescript` `visualizer` `workflow`

- [fslongjin/This-repo-has-1352-stars](https://github.com/fslongjin/This-repo-has-1352-stars)
  - ⭐: 1,352
  - 📖: 这个仓库有1352个star，不信你试试
...
- [international-explore/awesome-privacy-chinese](https://github.com/international-explore/awesome-privacy-chinese)
  - ⭐: 92
  - 📖: [WIP]国内隐私合规技术交流
  - 💡: `compliance` `gdpr` `privacy` `privacy-computing` `privacy-tools` `security`
...
- [NvChad/NvChad](https://github.com/NvChad/NvChad)
  ...
  - 💡: `dotfiles` `editor` `foss` `hacktoberfest` `ide` `lua` `neovim` `neovim-config` `neovim-configuration` `neovim-dotfiles` `neovim-lua` `neovim-setup` `nvim` `nvim-configs` `open-source` `rice` `ricing` `vim` `vimrc` `vscode`
...
- [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)
  ...
  - 💡: `hacktoberfest` `python` `sponskrub` `sponsorblock` `video-downloader` `youtube-dl` `youtube-dlc` `youtube-downloader` `yt-dlp`
...
- [octokit/octokit.js](https://github.com/octokit/octokit.js)
  ...
  - 💡: `github` `javascript` `octokit` `octokit-js` `sdk`
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid)
  ...
  - 💡: `documentation` `flowchart` `hacktoberfest` `hacktoberfest2022` `javascript` `typescript` `uml-diagrams`
...
- [DouyinFE/semi-design](https://github.com/DouyinFE/semi-design)
  ...
  - 💡: `custom-design-system` `dark-mode` `design-system` `dsm` `react` `typescript` `ui-libary`
...
- [modern-js-dev/modern.js](https://github.com/modern-js-dev/modern.js)
  - ⭐: 2,772
  - 📖: The meta-framework suite designed from scratch for frontend-focused modern web development.
  - 💡: `boilerplate` `framework` `react` `webapp`
...
- [www-chao-fun/chaofun-front](https://github.com/www-chao-fun/chaofun-front)
  - ⭐: 134
...
- [Tencent/APIJSON](https://github.com/Tencent/APIJSON)
  ...
  - 💡: `baas` `clickhouse` `db2` `fastjson` `hadoop` `hive` `low-code` `lowcode` `mysql` `mysql-server` `nocode` `oracle` `postgresql` `postgresql-database` `serverless` `serverless-plugin` `springboot` `sqlserver` `tdengine` `tidb`
...
- [AshoneA/BLTranslate](https://github.com/AshoneA/BLTranslate)
  - ⭐: 6
  - 📖: BLTranslate
...
- [ZhongAnTech/zarm](https://github.com/ZhongAnTech/zarm)
  - ⭐: 1,461
  - 📖: 基于 React 的移动端UI组件库
  - 💡: `frontend` `javascript` `react` `react-components` `react-ui`
...
- [storybookjs/storybook](https://github.com/storybookjs/storybook)
  ...
  - 💡: `angular` `components` `design-systems` `documentation` `ember` `hacktoberfest` `html` `javascript` `react` `react-native` `storybook` `styleguide` `svelte` `testing` `typescript` `ui` `ui-components` `vue` `web-components` `webpack`
...
- [theonedev/onedev](https://github.com/theonedev/onedev)
  ...
  - 💡: `continuous-deployment` `continuous-integration` `devops` `docker` `git` `kanban` `kubernetes` `self-hosted`
...
- [xiaoming2028/FreePAC](https://github.com/xiaoming2028/FreePAC)
  ...
  - 💡: `brook` `hostinger` `hostwinds` `shadowsocks` `shadowsocksr` `ss` `ssr` `v2ray` `vpn` `vps` `wireguard`
...
- [jaywcjlove/hotkeys](https://github.com/jaywcjlove/hotkeys)
  ...
  - 💡: `hotkey` `hotkeys` `javascript` `keyboard` `keyboard-shortcuts` `keymaster` `keypress` `masterkey` `shortcut` `shortcutkey` `shortcuts`
...
- [microsoft/react-native-code-push](https://github.com/microsoft/react-native-code-push)
  ...
  - 💡: `code-push` `codepush` `react-native`

- [CodeRabbitYu/ShiTu](https://github.com/CodeRabbitYu/ShiTu)
  - ⭐: 1,117
...
- [1995parham/github-do-not-ban-us](https://github.com/1995parham/github-do-not-ban-us)
  ...
  - 💡: `github` `github-for-everyone` `iran` `iranian` `sanction` `sanctions`

- [vonovak/react-navigation-mst-demo](https://github.com/vonovak/react-navigation-mst-demo)
  - ⭐: 36
...
- [react-native-text-input-mask/react-native-text-input-mask](https://github.com/react-native-text-input-mask/react-native-text-input-mask)
  - ⭐: 1,121
...
- [electrode-io/electrode-native](https://github.com/electrode-io/electrode-native)
  - ⭐: 694
  - 📖: A platform to ease integration&delivery of React Native apps in existing mobile applications
  - 💡: `android` `ios` `mobile` `nodejs` `react-native`

- [ngu2008/wanandroid](https://github.com/ngu2008/wanandroid)
  - ⭐: 479
...
- [haixiangyan/codeblock-beautifier](https://github.com/haixiangyan/codeblock-beautifier)
  - ⭐: 117
...
- [claus/react-dat-gui](https://github.com/claus/react-dat-gui)
  - ⭐: 284
  - 📖: React dat.GUI

- [Q42/delighters](https://github.com/Q42/delighters)
  - ⭐: 743
...
- [arbelh/HalfStyle](https://github.com/arbelh/HalfStyle)
  - ⭐: 772
...
- [microsoft/terminal](https://github.com/microsoft/terminal)
  ...
  - 💡: `cmd` `command-line` `console` `terminal` `windows-console` `windows-terminal` `wsl`

- [airuikun/technology-blog](https://github.com/airuikun/technology-blog)
  - ⭐: 3,117
...
- [aliyunfe/weekly](https://github.com/aliyunfe/weekly)
  - ⭐: 1,732
  - 📖: 《阿里云前端技术周刊》
  - 💡: `javascript` `js` `nodejs` `react` `vue` `web`

- [openbilibili/go-common](https://github.com/openbilibili/go-common)
  - ⭐: 9,161
...
- [WebAssembly-cn/website](https://github.com/WebAssembly-cn/website)
  - ⭐: 86
...
- [phodal/fde](https://github.com/phodal/fde)
  - ⭐: 193
...
- [reactjs/zh-hans.reactjs.org](https://github.com/reactjs/zh-hans.reactjs.org)
  - ⭐: 587
  - 📖: React documentation website in Simplified Chinese [Beta](https://beta.react.jscn.org)
...
- [leftstick/js-interview-online](https://github.com/leftstick/js-interview-online)
  - ⭐: 14
  - 📖: JavaScript测验小工具
...
- [GoogleCloudPlatform/microservices-demo](https://github.com/GoogleCloudPlatform/microservices-demo)
  ...
  - 💡: `gcp` `gke` `google-cloud` `grpc` `istio` `kubernetes` `kustomize` `opencensus` `sample-application` `samples` `skaffold` `terraform`
...
- [tldr-pages/tldr](https://github.com/tldr-pages/tldr)
  ...
  - 💡: `command-line` `console` `documentation` `examples` `hacktoberfest` `help` `man-page` `manpages` `manual` `shell` `terminal` `tldr`
...
- [qiu8310/minapp](https://github.com/qiu8310/minapp)
  - ⭐: 925
  - 📖: 重新定义微信小程序的开发
...
- [jsdf/little-virtual-computer](https://github.com/jsdf/little-virtual-computer)
  - ⭐: 848
...
- [hangxingliu/vscode-coding-tracker](https://github.com/hangxingliu/vscode-coding-tracker)
  - ⭐: 155
  - 📖: :clock10: A coding activities tracker(time, file, type)
  - 💡: `report` `tracker` `vscode` `vscode-extension`
...
- [haoel/christmas](https://github.com/haoel/christmas)
  - ⭐: 31
  - 📖: CSS Christmas Tree
...
- [developit/jsxobj](https://github.com/developit/jsxobj)
  - ⭐: 212
...
- [jpush/jpush-react-native](https://github.com/jpush/jpush-react-native)
  - ⭐: 1,294
...
- [BcRikko/css-collection](https://github.com/BcRikko/css-collection)
  - ⭐: 86
...
- [somonus/react-native-echarts](https://github.com/somonus/react-native-echarts)
  - ⭐: 719
  - 📖: Echarts for react-native. The react-naitve chart.

- [react-native-svg/react-native-svg](https://github.com/react-native-svg/react-native-svg)
  - ⭐: 6,335
  - 📖: SVG library for React Native, React Native Web, and plain React web projects.

- [JesperLekland/react-native-svg-charts](https://github.com/JesperLekland/react-native-svg-charts)
  - ⭐: 2,161
...
- [sunoj/jjb](https://github.com/sunoj/jjb)
  - ⭐: 3,118
  - 📖: 一个帮助你自动申请京东价格保护的chrome拓展
  - 💡: `browser-extension` `chrome` `chrome-extension` `firefox` `firefox-addon` `jd` `webextension`

- [chenxiaochun/blog](https://github.com/chenxiaochun/blog)
  - ⭐: 158
  - 📖: 🖋️ChenXiaoChun's blog

- [chenxiaochun/mobx-state-tree](https://github.com/chenxiaochun/mobx-state-tree)
  - ⭐: 66
  - 📖: mobx-state-tree 中文教程

- [MoeFE/Lyric](https://github.com/MoeFE/Lyric)
  - ⭐: 79
  - 📖: ✨ 一款非常实用的在线LRC歌词编辑器 (〃ﾉωﾉ)
  - 💡: `lrc` `lyrics` `netease-cloud-api` `qqmusic` `typescript` `vue`

- [sunnylqm/react-native-storage](https://github.com/sunnylqm/react-native-storage)
  - ⭐: 2,883
...
- [instea/react-native-popup-menu](https://github.com/instea/react-native-popup-menu)
  - ⭐: 1,340
...
- [fram-x/FluidTransitions](https://github.com/fram-x/FluidTransitions)
  - ⭐: 2,888
  - 📖: Fluid Transitions for React Navigation
  - 💡: `animation` `react-native` `react-navigation` `shared-element-transition` `transition`

- [KoderLabs/ngx-device-detector](https://github.com/KoderLabs/ngx-device-detector)
  - ⭐: 455
...
- [crazycodeboy/RNStudyNotes](https://github.com/crazycodeboy/RNStudyNotes)
  - ⭐: 3,911
  - 📖: React Native 研究与实践
  - 💡: `react-native` `react-native-doc` `react-native-lesson` `react-native-resources` `react-native-study` `react-native-tutorial`
...
- [ptelad/react-native-iphone-x-helper](https://github.com/ptelad/react-native-iphone-x-helper)
  - ⭐: 938
...
- [mobxjs/mobx-state-tree](https://github.com/mobxjs/mobx-state-tree)
  ...
  - 💡: `mobx` `mobx-state-tree` `mst` `observable` `redux` `snapshot` `state-management` `state-tree`

- [wix/Detox](https://github.com/wix/Detox)
  - ⭐: 9,931
  - 📖: Gray box end-to-end testing and automation framework for mobile apps
  - 💡: `android` `automation` `e2e-tests` `hacktoberfest` `hacktoberfest2021` `ios` `javascript` `react-native` `test-automation` `testing` `testing-tools`
...
- [lorien/awesome-web-scraping](https://github.com/lorien/awesome-web-scraping)
  ...
  - 💡: `anti-captcha` `awesome` `awesome-list` `captcha-breaking` `captcha-recognition` `captcha-solver` `captcha-solving` `data-processing` `go` `golang` `javascript` `php` `proxy` `proxy-list` `proxy-server` `proxylist` `proxyserver` `python` `ruby` `web-scraping`

- [pburtchaell/redux-promise-middleware](https://github.com/pburtchaell/redux-promise-middleware)
  - ⭐: 1,997
...
- [steelsojka/lodash-decorators](https://github.com/steelsojka/lodash-decorators)
  - ⭐: 720
...
- [alibaba/ice](https://github.com/alibaba/ice)
  - ⭐: 17,337
  - 📖: 🚀 Icejs: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
...
- [angular-schule/angular-cli-ghpages](https://github.com/angular-schule/angular-cli-ghpages)
  ...
  - 💡: `angular` `angular-cli` `angular-cli-ghpages` `gh-pages` `github-page` `ng-deploy` `travis-ci`
...
- [jezen/is-thirteen](https://github.com/jezen/is-thirteen)
  - ⭐: 5,398
...
- [camsong/fetch-jsonp](https://github.com/camsong/fetch-jsonp)
  - ⭐: 969
...
- [microsoft/vscode](https://github.com/microsoft/vscode)
  - ⭐: 137,599
  - 📖: Visual Studio Code
  - 💡: `editor` `electron` `hacktoberfest` `microsoft` `typescript` `visual-studio-code`
...
- [umaar/performance-debugging-devtools-2018](https://github.com/umaar/performance-debugging-devtools-2018)
  - ⭐: 12
  - 📖: null
...
- [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch)
  ...
  - 💡: `automated-testing` `chromedriver` `end-to-end-testing` `javascript` `nightwatch` `nightwatchjs` `nodejs` `selenium` `selenium-server` `selenium-webdriver` `testing` `w3c-webdriver` `webdriver`
...
- [NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd)
  ...
  - 💡: `angular` `angular-components` `angular-directives` `angular-ui-components` `angular14` `ant` `ant-design` `antd` `enterprise` `frontend` `ivy` `ng-zorro` `ngx` `typescript` `ui-components`
...
- [cytoscape/cytoscape.js](https://github.com/cytoscape/cytoscape.js)
  ...
  - 💡: `analysis` `cytoscapejs` `graph-theory` `javascript` `network` `visualisation`
...
- [superRaytin/redux-saga-in-chinese](https://github.com/superRaytin/redux-saga-in-chinese)
  - ⭐: 638
  - 📖: Redux-saga 中文文档
...
- [MagicCube/tensorflow-rex-run](https://github.com/MagicCube/tensorflow-rex-run)
  - ⭐: 638
...
- [Foveluy/Dragact](https://github.com/Foveluy/Dragact)
  - ⭐: 761
