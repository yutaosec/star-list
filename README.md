...
- [fslongjin/This-repo-has-1292-stars](https://github.com/fslongjin/This-repo-has-1292-stars)
  - ⭐: 1,292
  - 📖: 这个仓库有1292个star，不信你试试
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy)
  ...
  - 💡: `curl` `notifications` `pubsub` `push-notifications` `rest-api`
