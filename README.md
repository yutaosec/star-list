...
- [fslongjin/This-repo-has-1374-stars](https://github.com/fslongjin/This-repo-has-1374-stars)
  - ⭐: 1,374
  - 📖: 这个仓库有1374个star，不信你试试
...
- [evanw/esbuild](https://github.com/evanw/esbuild)
  ...
  - 💡: `bundler` `commonjs` `compiler` `css` `es6` `javascript` `jsx` `minifier` `react` `tsx` `typescript`
