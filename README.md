...
- [fslongjin/This-repo-has-1294-stars](https://github.com/fslongjin/This-repo-has-1294-stars)
  - ⭐: 1,294
  - 📖: 这个仓库有1294个star，不信你试试
...
- [NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd)
  ...
  - 💡: `angular` `angular-components` `angular-directives` `angular-ui-components` `angular13` `ant` `ant-design` `antd` `enterprise` `frontend` `ivy` `ng-zorro` `ngx` `typescript` `ui-components`
